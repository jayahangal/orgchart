...
public class TreeView extends Display {
    ...
    //public static final String TREE_CHI = "file:///Users/jaya/orgchart/sun-orgchart.xml";
    public static final String TREE_CHI = "/sun-orgchart.xml";
    ...
    public TreeView(Tree t, String label) {
        ...
        ItemAction textColor = new OrgColorAction(treeNodes,
    ...
    public static void main(String argv[]) {
        ...
        JFrame frame = new JFrame("s u n - o r g c h a r t |  t r e e v i e w");
    ...
    public static JComponent demo(String datafile, final String label) {
		...
		if (item.isExpanded() && !isLeafNode(item)) {
		     g = new GeographyChart(item.getString(label));		    
		}
            }
